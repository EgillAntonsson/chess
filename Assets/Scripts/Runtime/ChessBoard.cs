...
namespace Chess
{
	public class ChessBoard
	{
		...
		public (IEnumerable<Tile> changedTiles, Tile[,] tiles) MovePiece(TileWithPiece twp, Position pos, Dictionary<Position, (TileWithCastlingPiece, Position)> castlingTileByCheckableTilePosition)
		{
